...
public protocol TransportStrategyProtocol: Sendable {
...
public struct StaticTransportStrategy: TransportStrategyProtocol, Sendable {
    ...
    */
    ...
    public static func withGrpcConfig(grpcConfig: GrpcConfigurationProtocol)
        -> TransportStrategyProtocol
    {
