                ...
                return GetResponse.error(
                    GetError(
                        error: SdkError.UnknownError(
                            UnknownError(message: "unknown cache get result: '\(result)'"))
                    ))
            }
        ...
        do {
            ...
            return DeleteResponse.error(
                DeleteError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown cache set error: '\(error)'",
        ...
        do {
            ...
            default:
                return ListFetchResponse.error(
                    ListFetchError(
                        error: SdkError.UnknownError(
                            UnknownError(message: "unknown list fetch result: \(result)")))
                )
            }
        } catch let err as GRPCStatus {
            let sdkError = await processError(err: err, call: call)
        ...
        do {
            ...
            default:
                return ListLengthResponse.error(
                    ListLengthError(
                        error: SdkError.UnknownError(
                            UnknownError(message: "unknown list length result: \(result)")))
                )
            }
        } catch let err as GRPCStatus {
            let sdkError = await processError(err: err, call: call)
        ...
        do {
            ...
            default:
                return ListPopBackResponse.error(
                    ListPopBackError(
                        error: SdkError.UnknownError(
                            UnknownError(message: "unknown list pop back result: \(result)")))
                )
            }
        } catch let err as GRPCStatus {
            let sdkError = await processError(err: err, call: call)
            ...
            return ListPopBackResponse.error(
                ListPopBackError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown list pop back error: '\(error)'",
                            innerException: error))
                )
            )
        }
        ...
        do {
            ...
            default:
                return ListPopFrontResponse.error(
                    ListPopFrontError(
                        error: SdkError.UnknownError(
                            UnknownError(message: "unknown list pop front result: \(result)")))
                )
            }
        } catch let err as GRPCStatus {
            let sdkError = await processError(err: err, call: call)
            ...
            return ListPopFrontResponse.error(
                ListPopFrontError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown list pop front error: '\(error)'",
                            innerException: error))
                )
            )
        }
        ...
        do {
            ...
            return ListPushBackResponse.error(
                ListPushBackError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown list push back error: '\(error)'",
                            innerException: error))
                )
            )
        }
        ...
        do {
            ...
            return ListPushFrontResponse.error(
                ListPushFrontError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown list push front error: '\(error)'",
                            innerException: error))
                )
            )
        }
        ...
        do {
            ...
            return ListRetainResponse.error(
                ListRetainError(
                    error: SdkError.UnknownError(
                        UnknownError(
                            message: "unknown list retain error: '\(error)'",
                            innerException: error
                        )
                    )
                )
